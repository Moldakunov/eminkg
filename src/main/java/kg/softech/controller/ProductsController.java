...
import kg.softech.model.Review;
import kg.softech.model.product.Product;
import kg.softech.model.product.SizeColor;
import kg.softech.model.products.Categories;
import kg.softech.model.products.SearchText;
import kg.softech.model.products.SubCategories;
...
public class ProductsController {
    ...
    public String getProductBySeoUrl(@PathVariable String seoUrl,
                                     Model model,
        ...
        //System.out.println(calculateRatingGrouping(reviews));
    ...
    public HashMap<String, Object> getAllInfoBySeoUrl(String seoUrl){
        ...
        try {
            ...
            JSONArray similarProducts = new JSONObject(builder.toString()).getJSONArray("similarProducts");
            ...
            if (builder.toString().contains("description")) {
                description = new JSONObject(builder.toString()).getJSONObject("description").getString("text");
            ...
            if (builder.toString().contains("sizesColors")) {
                ...
                for (int i = 0; i < sizesColorsArray.length(); i++) {
                    sizeColor = (gson.fromJson(sizesColorsArray.getJSONObject(i).toString(), SizeColor.class));
    ...
    public static List<Categories> getCategoriesByStoreId() {
        ...
        try {
            ...
            JSONArray categoriesArray = new JSONObject(builder.toString()).getJSONArray("сategory");

            for (int i = 0; i < categoriesArray.length(); i++) {
                categories.add(new Gson().fromJson(categoriesArray.getJSONObject(i).toString(), Categories.class));
                ...
                for (int j = 0; j < categories.get(i).getSubCategory().size(); j++) {
                    categories
                            ...
                            .getSubCategory()
                            .get(j)
                            .setTranslit(Categories
                                    .transliterate(categories
                                            .get(i)
                                            .getSubCategory()
                                            .get(j)
                                            .getName()));
